import routerConstant from './constants/router.constant.js'
import ModeFactory from './history/factory.js'

import { RouterHashLink, RouterHistoryLink } from './elements/router-link.js'
import { RouterView } from './elements/router-view.js'
...
class Router {
    ...
    #config() {
        const modeFactory = new ModeFactory(this.#mode, {base: this.#base, routes: this.#routes, element: this.#element, events: this.#events})
